# Description: A Narcissistic Number is a positive number which is the sum of its own digits, each raised to the
...
def narcissistic(value):
    ...
    for letter in text_value:
        narcisSum += int(letter) ** len(text_value)
    return narcisSum == value
